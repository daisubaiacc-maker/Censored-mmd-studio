...
export function createPCUIImplementation(app: HTMLElement): PCUIElements {
  app.innerHTML = `
    <main class="studio-shell studio-shell-pc">
      ...
      <aside class="studio-panel studio-panel-pc" aria-label="Studio controls">
        ...
        <div class="camera-touch-controls" aria-label="Camera touch controls"><span class="camera-touch-label">Camera</span><input id="camera-zoom" class="camera-zoom" type="range" min="0" max="1" step="0.001" value="0.5" aria-label="Camera zoom" /></div>
        <hr />
